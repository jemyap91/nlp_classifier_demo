"""
Project Type Classifier - Optimized for Speed & Accuracy
...
MAX_LENGTH = 64   # Reduced - most project titles are short
...
# ==================== PAGE CONFIGURATION ====================
st.set_page_config(
    page_title="Project Classifier Pro",
    page_icon="",
    layout="wide",
...
def load_model_optimized():
    ...
    try:
        ...
        return model, tokenizer, original_id2label, consolidated_classes
...
def batch_predict_optimized(texts, model, tokenizer, original_id2label, consolidated_classes):
    if not texts:
        return [], [], []
...
def main():
    # Header
    st.markdown("<h1>Project Classifier Pro</h1>", unsafe_allow_html=True)
    ...
    with st.spinner("Initializing AI model..."):
        model, tokenizer, original_id2label, consolidated_classes = load_model_optimized()
